<template>
  <div class="Seal">
    ...
    >
      ...
      >
        <el-form-item label="公司名称" :label-width="InsertformLabelWidth">
          <el-input
            readonly
            v-model.trim="Updateform.companyName"
            autocomplete="off"
        ...
        <el-form-item label="印章确认状态" :label-width="InsertformLabelWidth">
          ...
          >
            ...
            <el-option value="3" label="平台已否认">平台已否认</el-option>
        ...
        <el-form-item label="印章预览" :label-width="InsertformLabelWidth">
          ...
          <el-upload
            ...
            :limit="1"
          >
            <el-button size="small" type="primary">上传标准印章</el-button>
            <br />
              ...
              if (res.status == 200) {
                if (res.data.status == 1) {
                  ...
                  for (let list = 1; list <= res.data.request.length; list++) {
                    let sealIsenable =
                      res.data.request[list - 1].isenable == 1
                        ? "启用"
                        : "禁用";
                    let sealSealType =
