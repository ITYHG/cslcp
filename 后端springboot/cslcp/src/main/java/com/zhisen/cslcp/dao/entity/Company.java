...
public class Company extends BaseEntity implements Serializable
{
	...
	public String toString() {
		return "Company [id=" + id + ", name=" + name + ", companytypeid=" + companytypeid + ", companyTypeName="
				...
				+ level + ", countryId=" + countryId + ", countryName=" + countryName + ", provinceId=" + provinceId
				+ ", provinceName=" + provinceName + ", cityId=" + cityId + ", cityName=" + cityName + ", address="
				+ address + ", creditcode=" + creditcode + ", cerificateattachment1=" + cerificateattachment1
				+ ", cerificateattachment2=" + cerificateattachment2 + ", phone=" + phone + ", email=" + email
				+ ", adminaccountid=" + adminaccountid + ", status=" + status + ", issendbl=" + issendbl
				+ ", isreceive=" + isreceive + ", isenableseal=" + isenableseal + ", createdate=" + createdate
				+ ", createuserid=" + createuserid + ", createusername=" + createusername + ", modifydate=" + modifydate
				+ ", modifyuserid=" + modifyuserid + ", modifyusername=" + modifyusername + ", isdel=" + isdel
				+ ", version=" + version + ", file=" + file + ", Sealfile1=" + Sealfile1 + ", Sealfile2=" + Sealfile2
				+ "]";
	}
